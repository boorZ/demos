...
import com.example.springbootdatademo.BeanConfig;
...
public class C3P0Utils {
    ...
    public static Connection getconnection() throws SQLException, PropertyVetoException {
        ...
        cpds.setJdbcUrl("jdbc:mysql:///"+ BeanConfig.SQL_DATABASE +"?serverTimezone=GMT%2B8&useUnicode=true&characterEncoding=utf-8");
        cpds.setUser(BeanConfig.SQL_USER);
        cpds.setPassword(BeanConfig.SQL_PASSWORD);
        // 得到一个Connection
    ...
    public static ResultSet getconnection(String sql) throws SQLException, PropertyVetoException {
        cpds = new ComboPooledDataSource();
        cpds.setDriverClass("com.mysql.cj.jdbc.Driver");
        cpds.setJdbcUrl("jdbc:mysql://"+BeanConfig.SQL_IP +"/"+BeanConfig.SQL_DATABASE +
